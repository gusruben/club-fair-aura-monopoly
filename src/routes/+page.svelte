...
<div class="fixed inset-0 bg-gray-950 overflow-hidden">
    <div class="flex flex-col gap-5 justify-center">
        <h1 class="font-sans font-bold text-white text-[10rem] uppercase text-center opacity-20 leading-none h-20">Find Your Fortune</h1>
        <h1 class="font-sans text-white text-[8rem] text-center leading-none z-10">
    ...
    <div class="bg-gray-900 w-2/3 mx-auto my-10 p-5 rounded-lg border-gray-800 border-2 text-3xl text-white">
        1234: This is your fortune, you better enjoy it!
    </div>
    <!-- <div class="bg-gray-900 w-2/3 mx-auto my-5 p-5 rounded-lg border-gray-800 border-2 text-3xl scale-75 text-white">1234: This is your fortune, you better enjoy it!</div> -->
