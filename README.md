...
It's a website meant to be run on a TV at club fairs, and when someone texts the number on-screen, their fortune will appear on screen (with the last 4 digits of their phone number to identify them). Fortunes are generated by AI, and might be a little ominous >:)
